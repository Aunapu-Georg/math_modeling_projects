...
moon, = plt.plot([], [], 'o', color='darkgrey', ms = 3)
moon_trajectory, = plt.plot([], [], '-', color='lightgrey', lw=1)
launch_vehicle, = plt.plot([], [], 'o', color='red', ms=1)
launch_vehicle_trajectory, = plt.plot([], [], '-', color='tomato', lw=0.2)
plt.plot([earth_focal_length], [0], 'o', color='royalblue', ms=12)
